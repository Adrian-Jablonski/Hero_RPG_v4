...
export default class Area100_100 extends BaseScene {
    ...
    create() {
        // super.characterLocation([150, 100])

        var sceneBorders = {x: [40, 480], y: [40, 460]}; // Scene dimensions
        var areaChanges = {northChange : "None", eastChange : "None", southChange : "None", westChange : [sceneBorders.x[0] - 30, sceneBorders.x[0] + 30, 220, 275]}; // Defines part of scene where the user transitions to other scene
        var areaChangeTo = {northChange : "none", eastChange : "None", westChange : "Area99_100"};
